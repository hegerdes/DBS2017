...
class BrowseController extends Controller
{
    ...
    {
        $user = $this->getUser();
        $exams = $this->getDoctrine()->getRepository('OpiumBundle:Exam')->findEnrolledExamsByUser($user);
        //$exams = [];
        // TODO: Find all exams in which the currently logged in user is endrolled
        return ['exams' => $exams];
    }
    ...
    public function resultsAction()
    {
        ...
        $user = $this->getUser();
        $exams = $this->getDoctrine()->getRepository('OpiumBundle:Exam')->findResultsExamsByUser($user);

        // TODO: Find all exams for which the currently logged in user has received a grade
        //$exams = [];
